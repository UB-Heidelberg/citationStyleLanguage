...
class CitationStyleLanguageHandler extends Handler {
	...
	public function get($args, $request) {
		...
		$citation = $plugin->getCitation($request, $this->submission, $this->citationStyle, $this->publication);
	...
	public function _setupRequest($args, $request) {
		...
		$this->submission = $submissionDAO->getById( (int) $userVars['submissionId'] );
